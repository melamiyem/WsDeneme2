 ...
 *         &lt;element name="KAYITSORGU_ARR" type="{http://tempuri.org/}ArrayOfKayitSorguTamamla" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ALISKayitSorguTamamlandi")
public class ALISKayitSorguTamamlandi {

    @XmlElement(name = "VENUSER")
    protected String venuser;
    @XmlElement(name = "VENPASS")
    protected String venpass;
    @XmlElement(name = "KAYITSORGU_ARR")
